...
//         PYBIND11_OVERRIDE_PURE_NAME(std::size_t, EnvBase, "get_state_space_size",
//         GetStateSpaceSize);
//     }
//
//     [[nodiscard]] std::size_t
//     GetActionSpaceSize() const override {
//         PYBIND11_OVERRIDE_PURE_NAME(std::size_t, EnvBase, "get_action_space_size",
//         GetActionSpaceSize);
//     }
//
//     [[nodiscard]] std::vector<std::shared_ptr<EnvironmentState>>
//     ForwardAction(const std::shared_ptr<const EnvironmentState> &env_state, const
//     std::vector<int> &action_coords) const override {
//         PYBIND11_OVERRIDE_PURE_NAME(std::vector<std::shared_ptr<EnvironmentState>>, EnvBase,
//         "forward_action", ForwardAction, env_state, action_coords);
//     }
//
//     [[nodiscard]] std::vector<Successor>
//     GetSuccessors(const std::shared_ptr<EnvironmentState> &env_state) const override {
//         PYBIND11_OVERRIDE_PURE_NAME(std::vector<Successor>, EnvBase, "get_successors",
//         GetSuccessors, env_state);
//     }
//
//     [[nodiscard]] bool
...
//         PYBIND11_OVERRIDE_PURE_NAME(Eigen::VectorXi, EnvBase, "metric_to_grid", MetricToGrid,
//         metric_state);
//     }
//
//     [[nodiscard]] Eigen::VectorXd
//     GridToMetric(const Eigen::Ref<const Eigen::VectorXi> &grid_state) const override {
//         PYBIND11_OVERRIDE_PURE_NAME(Eigen::VectorXd, EnvBase, "grid_to_metric", GridToMetric,
//         grid_state);
//     }
//
//     [[nodiscard]] cv::Mat
...
//         PYBIND11_OVERRIDE_PURE_NAME(std::vector<std::shared_ptr<EnvironmentState>>, EnvBase,
//         "sample_valid_states", SampleValidStates, num_samples);
//     }
// };
//
...
//         PYBIND11_OVERRIDE_PURE_NAME(std::size_t, EnvBase, "get_num_resolution_levels",
//         GetNumResolutionLevels);
//     }
//
//     [[nodiscard]] std::vector<Successor>
//     GetSuccessorsAtLevel(const std::shared_ptr<EnvironmentState> &state, std::size_t
//     resolution_level) const override {
//         PYBIND11_OVERRIDE_PURE_NAME(std::vector<Successor>, EnvBase, "get_successors_at_level",
//         GetSuccessorsAtLevel, state, resolution_level);
//     }
//
//     [[nodiscard]] bool
//     InStateSpaceAtLevel(const std::shared_ptr<EnvironmentState> &env_state, std::size_t
//     resolution_level) const override {
//         PYBIND11_OVERRIDE_PURE_NAME(bool, EnvBase, "in_state_space_at_level",
//         InStateSpaceAtLevel, env_state, resolution_level);
//     }
// };
//
// static void
...
//
//     py::class_<EuclideanDistanceCost, CostBase, std::shared_ptr<EuclideanDistanceCost>>(m,
//     "EuclideanDistanceCost").def(py::init<>()); py::class_<ManhattanDistanceCost, CostBase,
//     std::shared_ptr<ManhattanDistanceCost>>(m, "ManhattanDistanceCost").def(py::init<>());
// }
//
// static void
...
//     py::class_<scene_graph::Object, YamlableBase, std::shared_ptr<scene_graph::Object>> object(m,
//     "Object"); object.def_readwrite("action_affordance", &scene_graph::Object::action_affordance)
...
//     py::enum_<scene_graph::Object::SOC>(object, "SOC", py::arithmetic(), "Special object
//     category.")
...
//     py::class_<scene_graph::Building, YamlableBase, std::shared_ptr<scene_graph::Building>>(m,
//     "Building")
...
//         .def("get_object_node", &scene_graph::Building::GetNode<erl::env::scene_graph::Object>,
//         py::arg("object_id")) .def("get_room_node",
//         &scene_graph::Building::GetNode<erl::env::scene_graph::Room>, py::arg("room_id"))
//         .def("load_room_map", &scene_graph::Building::LoadRoomMap, py::arg("data_dir"),
//         py::arg("floor_id")) .def("load_cat_map", &scene_graph::Building::LoadCatMap,
//         py::arg("data_dir"), py::arg("floor_id"));
// }
//
// static void
// BindAtomicProposition(py::module &m) {
//     py::class_<AtomicProposition, YamlableBase, std::shared_ptr<AtomicProposition>> ap(m,
//     "AtomicProposition"); py::enum_<AtomicProposition::Type>(ap, "Type", py::arithmetic(), "Type
//     of atomic proposition.")
...
//         .export_values();
//     ap.def(py::init<>())
//         .def(py::init<AtomicProposition::Type, int, double>(), py::arg("type"), py::arg("uuid"),
//         py::arg("reach_distance")) .def_readwrite("type", &AtomicProposition::type)
...
//     py::class_<FiniteStateAutomaton, std::shared_ptr<FiniteStateAutomaton>> fsa(m,
//     "FiniteStateAutomaton"); py::class_<FiniteStateAutomaton::Setting, YamlableBase,
//     std::shared_ptr<FiniteStateAutomaton::Setting>> fsa_setting(fsa, "Setting");
//     py::class_<FiniteStateAutomaton::Setting::Transition>(fsa_setting, "Transition")
//         .def(py::init<>())
//         .def(py::init<uint32_t, uint32_t, std::set<uint32_t>>(), py::arg("from"), py::arg("to"),
//         py::arg("labels")) .def_readwrite("from",
//         &FiniteStateAutomaton::Setting::Transition::from) .def_readwrite("to",
//         &FiniteStateAutomaton::Setting::Transition::to) .def_readwrite("labels",
//         &FiniteStateAutomaton::Setting::Transition::labels);
//     py::enum_<FiniteStateAutomaton::Setting::FileType>(fsa_setting, "FileType", py::arithmetic(),
//     "Type of finite state automaton file")
...
//         .def(py::init<const std::string &, FiniteStateAutomaton::Setting::FileType>(),
//         py::arg("filepath"), py::arg("file_type")) .def_readwrite("num_states",
//         &FiniteStateAutomaton::Setting::num_states) .def_readwrite("initial_state",
//         &FiniteStateAutomaton::Setting::initial_state) .def_readwrite("accepting_states",
//         &FiniteStateAutomaton::Setting::accepting_states) .def_readwrite("atomic_propositions",
//         &FiniteStateAutomaton::Setting::atomic_propositions) .def_readwrite("transitions",
//         &FiniteStateAutomaton::Setting::transitions) .def("as_boost_graph_dot_file",
//         &FiniteStateAutomaton::Setting::AsBoostGraphDotFile, py::arg("filepath"))
//         .def("from_boost_graph_dot_file", &FiniteStateAutomaton::Setting::FromBoostGraphDotFile,
//         py::arg("filepath")) .def("as_spot_graph_hoa_file",
//         &FiniteStateAutomaton::Setting::AsSpotGraphHoaFile, py::arg("filepath"))
//         .def("from_spot_graph_hoa_file", &FiniteStateAutomaton::Setting::FromSpotGraphHoaFile,
//         py::arg("filepath"));
// }
//
// static void
...
//
//     py::class_<EnvironmentBase, PyEnvBase<>, std::shared_ptr<EnvironmentBase>>(m,
//     "EnvironmentBase")
//         .def(py::init_alias<std::shared_ptr<CostBase>, double>(),
//         py::arg("distance_cost_func").none(false), py::arg("time_step"))
...
//         .def("forward_action", &EnvironmentBase::ForwardAction, py::arg("env_state"),
//         py::arg("action_coords")) .def_property_readonly("distance_cost_func",
//         &EnvironmentBase::GetDistanceCostFunc) .def_property_readonly("time_step",
//         &EnvironmentBase::GetTimeStep) .def("get_successors", &EnvironmentBase::GetSuccessors,
//         py::arg("env_state").none(false)) .def("in_state_space", &EnvironmentBase::InStateSpace,
//         py::arg("env_state").none(false)) .def("state_hashing", &EnvironmentBase::StateHashing,
//         py::arg("env_state").none(false)) .def("metric_to_grid", &EnvironmentBase::MetricToGrid,
//         py::arg("metric_state")) .def("grid_to_metric", &EnvironmentBase::GridToMetric,
//         py::arg("grid_state")) .def("show_paths", &EnvironmentBase::ShowPaths, py::arg("paths"),
//         py::arg("block"));
//
//     auto env_2d = py::class_<Environment2D, EnvironmentBase, std::shared_ptr<Environment2D>>(m,
//     "Environment2D"); py::class_<Environment2D::Setting, YamlableBase,
//     std::shared_ptr<Environment2D::Setting>>(env_2d, "Setting")
//         .def(py::init<>())
...
//         .def("set_grid_motion_primitive", &Environment2D::Setting::SetGridMotionPrimitive,
//         py::arg("max_axis_step"), py::arg("allow_diagonal"));
//
//     env_2d
//         .def(
//             py::init<const std::shared_ptr<GridMapUnsigned2D> &,
//             std::shared_ptr<Environment2D::Setting>, std::shared_ptr<CostBase>>(),
//             py::arg("grid_map"),
//             py::arg("setting") = nullptr,
//             py::arg("distance_cost_func") = nullptr)
//         .def_property_readonly("setting", &Environment2D::GetSetting);
//
//     auto env_se2 = py::class_<EnvironmentSe2, EnvironmentBase,
//     std::shared_ptr<EnvironmentSe2>>(m, "EnvironmentSe2");
//
//     py::class_<EnvironmentSe2::Setting, YamlableBase,
//     std::shared_ptr<EnvironmentSe2::Setting>>(env_se2, "Setting")
//         .def(py::init<>())
...
//         .def(
//             py::init<const std::shared_ptr<GridMapUnsigned2D> &,
//             std::shared_ptr<EnvironmentSe2::Setting>>(), py::arg("grid_map"), py::arg("setting")
//             = nullptr)
//         .def_property_readonly("setting", &EnvironmentSe2::GetSetting)
//         .def_static("motion_model", &EnvironmentSe2::MotionModel, py::arg("metric_state"),
//         py::arg("control"), py::arg("t"));
//
//     py::class_<EnvironmentMultiResolution, PyEnvMultiResolution<>,
//     std::shared_ptr<EnvironmentMultiResolution>>(m, "EnvironmentMultiResolution")
//         .def(py::init_alias<>())
//         .def_property_readonly("num_resolution_levels",
//         &EnvironmentMultiResolution::GetNumResolutionLevels) .def("get_successor_at_level",
//         &EnvironmentMultiResolution::GetSuccessorsAtLevel, py::arg("env_state"),
//         py::arg("resolution_level")) .def("in_state_space_at_level",
//         &EnvironmentMultiResolution::InStateSpaceAtLevel, py::arg("env_state"),
//         py::arg("resolution_level"));
//
//     py::class_<EnvironmentAnchor, EnvironmentMultiResolution,
//     PyEnvMultiResolution<EnvironmentAnchor>, std::shared_ptr<EnvironmentAnchor>>(
//         m,
//         "EnvironmentAnchor")
//         .def(py::init_alias<std::vector<std::shared_ptr<EnvironmentBase>>>(),
//         py::arg("environments"));
//
//     py::class_<EnvironmentGridAnchor2D, EnvironmentAnchor,
//     std::shared_ptr<EnvironmentGridAnchor2D>>(m, "EnvironmentGridAnchor2D")
//         .def(
//             py::init<std::vector<std::shared_ptr<EnvironmentBase>>,
//             std::shared_ptr<GridMapInfo2D>>(), py::arg("environments"),
//             py::arg("grid_map_info").none(false));
//
//     py::class_<EnvironmentGridAnchor3D, EnvironmentAnchor,
//     std::shared_ptr<EnvironmentGridAnchor3D>>(m, "EnvironmentGridAnchor3D")
//         .def(
//             py::init<std::vector<std::shared_ptr<EnvironmentBase>>,
//             std::shared_ptr<GridMapInfo3D>>(), py::arg("environments"),
//             py::arg("grid_map_info").none(false));
//
//     py::class_<EnvironmentSceneGraph, EnvironmentMultiResolution,
//     PyEnvMultiResolution<EnvironmentSceneGraph>, std::shared_ptr<EnvironmentSceneGraph>>
//         env_graph(m, "EnvironmentSceneGraph");
//     py::class_<EnvironmentSceneGraph::Setting, YamlableBase,
//     std::shared_ptr<EnvironmentSceneGraph::Setting>>(env_graph, "Setting")
...
//         .def_readwrite("object_reach_distance",
//         &EnvironmentSceneGraph::Setting::object_reach_distance) .def_readwrite("shape",
//         &EnvironmentSceneGraph::Setting::shape) .def_readwrite("max_level",
//         &EnvironmentSceneGraph::Setting::max_level);
//     env_graph
//         .def(
//             py::init_alias<std::shared_ptr<scene_graph::Building>,
//             std::shared_ptr<EnvironmentSceneGraph::Setting>>(), py::arg("scene_graph"),
//             py::arg("setting") = nullptr)
...
//
//     py::class_<EnvironmentLTLSceneGraph, EnvironmentSceneGraph,
//     PyEnvMultiResolution<EnvironmentLTLSceneGraph>, std::shared_ptr<EnvironmentLTLSceneGraph>>
//         env_ltl_graph(m, "EnvironmentLTLSceneGraph");
//     py::class_<EnvironmentLTLSceneGraph::Setting, YamlableBase,
//     std::shared_ptr<EnvironmentLTLSceneGraph::Setting>>(env_ltl_graph, "Setting")
//         .def_readwrite("atomic_propositions",
//         &EnvironmentLTLSceneGraph::Setting::atomic_propositions) .def_readwrite("fsa",
//         &EnvironmentLTLSceneGraph::Setting::fsa) .def("load_atomic_propositions",
//         &EnvironmentLTLSceneGraph::Setting::LoadAtomicPropositions, py::arg("yaml_file"));
//     env_ltl_graph.def_property_readonly("finite_state_automaton",
//     &EnvironmentLTLSceneGraph::GetFiniteStateAutomaton)
...
PYBIND11_MODULE(PYBIND_MODULE_NAME, m) {
    ...
    //
    // py::class_<DifferentialDriveControl>(m, "DifferentialDriveControl", "Differential drive
    // control.")
    //     .def(py::init<>())
    ...
    //     .def(py::init<>())
    //     .def(
    //         py::init<std::vector<DifferentialDriveControl>, std::vector<double>,
    //         std::vector<double>>(), py::arg("controls"), py::arg("durations"), py::arg("costs"))
    ...
    //     .def("compute_trajectories", &DdcMotionPrimitive::ComputeTrajectorySegments,
    //     py::arg("state"), py::arg("dt"), py::arg("motion_model_function")) .def(
    //         "compute_trajectory",
    //         py::overload_cast<
    //             const Eigen::Ref<const Eigen::VectorXd> &,
    //             std::size_t,
    //             double,
    //             const std::function<Eigen::VectorXd(const Eigen::Ref<const Eigen::VectorXd> &,
    //             const DifferentialDriveControl &, double)> &>(
    ...
    //
    // m.def("load_ddc_motion_primitives_from_yaml", &LoadDdcMotionPrimitivesFromYaml,
    // py::arg("filename"));
    //
    // BindCosts(m);
    // BindSceneGraph(m);
